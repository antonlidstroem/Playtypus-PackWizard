    ...
    items: [
      {
        key: 'favorites',
        label: '⭐ Favoriter',
        desc: 'Användaren kan spara favoritaktiviteter med en lång-tryckning eller hjärtknapp. Visas i en dedikerad flik.',
        playtypusKey: 'features.favorites',
      },
      {
        key: 'favoritesShelf',
        label: '📚 Favorithylla',
        desc: 'Visar favoriter som en horisontell carousel på startsidan — snabb åtkomst utan att byta flik. Kräver att Favoriter är aktiverat.',
        requires: ['favorites'],
        playtypusKey: 'features.favoritesShelf',
      },
      {
        key: 'doneTracking',
        label: '✅ Klar-markering',
        desc: 'Aktiviteter kan markeras som genomförda. Visar framsteg med en checkmark och räknar totalt antal genomförda.',
        playtypusKey: 'features.doneTracking',
      },
      {
        key: 'recentHistory',
        label: '🕐 Nyligen visade',
        desc: 'Visar de 5 senaste aktiviteterna användaren klickade på, i en carousel på startsidan. Hjälper användaren att hitta tillbaka snabbt.',
        playtypusKey: 'features.recentHistory',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: 'logbook',
        label: '📖 Loggbok',
        desc: 'Sparar genomförda aktiviteter med datum, valfri anteckning och foto. Skapar en personlig äventyrsbok. Kräver doneTracking.',
        requires: ['doneTracking'],
        playtypusKey: 'features.logbook',
      },
      {
        key: 'streakTracking',
        label: '🔥 Streak-spårning',
        desc: 'Räknar dagliga streak-dagar och visar en framstegslista. Motiverar regelbunden användning. Konfigurera mål (t.ex. 7 dagar) nedan.',
        type: 'streak',
        playtypusKey: 'features.streakTracking',
      },
      {
        key: 'badges',
        label: '🏅 Badges / Medaljer',
        desc: 'Användaren tjänar in badges för milstolpar: 10 aktiviteter klara, 30-dagarstreak, alla kategorier utforskade m.m. Kräver doneTracking.',
        requires: ['doneTracking'],
        playtypusKey: 'features.badges',
      },
      {
        key: 'levelBadges',
        label: '🎖️ Svårighets-badges',
        desc: 'Visar en färgad badge på aktivitetskorten som indikerar svårighetsgrad (1=grön, 2=gul, 3=röd). Hjälper användaren att filtrera efter ambitionsnivå.',
        playtypusKey: 'features.levelBadges',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: 'shareActivity',
        label: '📤 Dela aktivitet',
        desc: 'Dela-knapp på varje aktivitet. Öppnar enhetens Web Share API (Skicka till, AirDrop, kopiera länk). Fungerar på iOS och Android.',
        playtypusKey: 'features.shareActivity',
      },
      {
        key: 'textToSpeech',
        label: '🔊 Uppläsning (TTS)',
        desc: 'Läser upp aktivitetens titel, beskrivning och steg med enhetens inbyggda text-till-tal. Passar för barn, tillgänglighet och hands-free-läge.',
        playtypusKey: 'features.textToSpeech',
      },
      {
        key: 'audioPlayer',
        label: '🎵 Ljudspelare',
        desc: 'Visar en inbäddad ljudspelare om aktivitetens contentBlocks innehåller audio-filer. Passar guidade meditationer och ljudberättelser.',
        playtypusKey: 'features.audioPlayer',
      },
      {
        key: 'printView',
        label: '🖨️ Utskriftsvänlig vy',
        desc: 'Lägger till en "Skriv ut"-knapp på aktivitetssidan som öppnar en formaterad utskriftsdialog. Bra för recept, handledningar och klassrum.',
        playtypusKey: 'features.printView',
      },
      {
        key: 'haptics',
        label: '📳 Haptisk återkoppling',
        desc: 'Lätta vibrationspulser vid knapptryckningar och markerade aktiviteter. Förbättrar appkänslan på mobilenheter. Ej märkbart på desktop.',
        playtypusKey: 'features.haptics',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: 'guidedMode',
        label: '📋 Guidad visning',
        desc: 'Lägger till en Starta-knapp och en Nästa-knapp på aktivitetssidan. Aktivitetens steps visas ett i taget, fokuserat. Passar träning, recept och guider.',
        playtypusKey: 'features.guidedMode',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: 'export',
        label: '📄 PDF-export',
        desc: 'Exportera loggboken som en formaterad PDF-fil. Kräver att Loggbok är aktiverat. Konfigureras med om foton ska inkluderas.',
        type: 'export',
        requires: ['logbook'],
        playtypusKey: 'features.export',
      },
    ],
  },
  {
    ...
    items: [
      {
        key: 'activityNotes',
        label: '📝 Aktivitetsanteckningar',
        desc: 'Användaren kan skriva en kort fritext-anteckning direkt på ett aktivitetskort, utan att det sparas i loggboken.',
        playtypusKey: 'features.activityNotes',
      },
      {
        key: 'cardActions',
        label: '⚡ Snabbknappar på kort',
        desc: 'Visar snabbknappar (Klar, Favorit, Dela) direkt på aktivitetskortet utan att öppna detaljvyn. Kompakta interaktioner.',
        playtypusKey: 'features.cardActions',
      },
      {
        key: 'fontSizeScale',
        label: '🔤 Textskalning',
        desc: 'Lägger till en textstorleksreglage i inställningar. Användaren kan skala text 80–140%. Förbättrar tillgängligheten.',
        playtypusKey: 'features.fontSizeScale',
      },
      {
        key: 'slideshow',
        label: '📽️ Presentationsläge',
        desc: 'Aktiviteter kan visas i ett helskärmsläge optimerat för projektor eller klassrum — steg för steg med stor text.',
        playtypusKey: 'features.slideshow',
      },
      {
        key: 'allowUserContent',
        label: '✏️ Användarskapade aktiviteter',
        desc: 'Tillåter användaren att skapa egna aktiviteter som sparas lokalt. Dessa syns bara för den användaren.',
        playtypusKey: 'features.allowUserContent',
      },
      {
        key: 'progressionLock',
        label: '🔒 Progressionslås',
        desc: 'Aktiviteter kan låsas i en sekvens — nästa aktivitet låses upp först när föregående är klar. Passar kursinnehåll och program.',
        playtypusKey: 'features.progressionLock',
      },
      {
        key: 'dataSync',
        label: '💾 Dataexport',
        desc: 'Tillåter användaren att exportera och importera lokal data (favoriter, klara aktiviteter, anteckningar) som JSON.',
        type: 'dataSync',
        playtypusKey: 'features.dataSync',
      },
      {
        key: 'reminders',
        label: '🔔 Påminnelser',
        desc: 'Skickar en daglig push-notis vid en vald tid för att påminna användaren om att göra en aktivitet.',
        type: 'reminders',
        playtypusKey: 'features.reminders',
      },
    ],
  },
      ...
      {FEATURE_GROUPS.map(group => {
        ...
        <div key={group.group} style={{ marginBottom: 32 }}>
          <div style={{ marginBottom: 12 }}>
            <h3 style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-2)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 3 }}>
              {group.group}
            </h3>
                  ...
                  {item.key === 'dataSync' && on && (
                    <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexShrink: 0 }}>
                      {['export-only', 'full'].map(mode => (
                        <button
                          key={mode}
                          onClick={() => updateFeatures({ dataSync: mode })}
                          style={{
                            ...
                            color: features.dataSync === mode ? 'var(--accent)' : 'var(--text-2)',
                            cursor: 'pointer',
                          }}
                        >
                          {mode === 'export-only' ? 'Export' : 'Export + Import'}
                        </button>
                      ))}
                    </div>
                  )}
